                                ...
                                <tr class="border-t border-gray-300 text-center">
                                    ...
                                    <td class="px-2 py-1">
                                        @if (isset($order->status->first()->title))
                                            <span
                                                class="inline-block px-3 py-1 rounded-full bg-green-500 text-white font-bold text-sm max-w-xs whitespace-nowrap">
                                                {{ $order->status->first()->title }}
                                            </span>
                                        @else
                                            <span
                                                class="inline-block px-3 py-1 rounded-full bg-red-500 text-white font-bold text-sm max-w-xs whitespace-nowrap">
                                                No Status
                                            </span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 items-center gap-2">
                                        ...
                                        <button data-tooltip-target="tooltip1" data-tooltip-style="light"
                                            {{ isset($order->status->first()->title) ? '' : 'disabled' }}
                                ...
                                <ul class="flex">
                                    <li>
                                        <a href="{{ $orders->previousPageUrl() }}"
                                            class="px-4 py-2 text-blue-600 transition-colors duration-150 bg-white border border-blue-600 rounded-l-lg focus:shadow-outline hover:bg-blue-100">Prev</a>
                                    </li>
                                    @for ($i = 1; $i <= $orders->lastPage(); $i++)
                                        <li>
                                            <a href="{{ $orders->url($i) }}"
                                                class="px-4 py-2 {{ $orders->currentPage() === $i ? 'text-white bg-blue-600' : 'text-blue-600 bg-white' }} border border-blue-600 focus:shadow-outline">{{ $i }}</a>
                                        </li>
                                    @endfor
                                    <li>
                                        <a href="{{ $orders->nextPageUrl() }}"
                                            class="px-4 py-2 text-blue-600 transition-colors duration-150 bg-white border border-blue-600 rounded-r-lg focus:shadow-outline hover:bg-blue-100">Next</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
