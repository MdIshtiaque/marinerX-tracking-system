            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-200 rounded-lg hover:bg-sky-200 group">
                        ...
                        <span class="flex-1 ml-3 text-white group-hover:text-black whitespace-nowrap">Kanban</span>
                        <span
                            class="inline-flex items-center justify-center px-2 ml-3 text-white group-hover:text-black text-sm font-medium text-gray-800 bg-sky-300 group-hover:bg-sky-500 rounded-full">Pro</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-200 rounded-lg hover:bg-sky-200 group">
                        ...
                        <span class="flex-1 ml-3 text-white group-hover:text-black whitespace-nowrap">Inbox</span>
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-white group-hover:text-black text-sm font-medium text-sky-800 bg-sky-300 rounded-full group-hover:bg-sky-500">3</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-200 rounded-lg hover:bg-sky-200 group">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-200 rounded-lg hover:bg-sky-200 group">
                        ...
                        <span class="flex-1 ml-3 text-white group-hover:text-black whitespace-nowrap">Products</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-200 rounded-lg hover:bg-sky-200 group">
                        ...
                        <span class="flex-1 ml-3 text-white group-hover:text-black whitespace-nowrap">Sign In</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-200 rounded-lg hover:bg-sky-200 group">
                        ...
                        <span class="flex-1 ml-3 text-white group-hover:text-black whitespace-nowrap">Sign Up</span>
                    </a>
                </li>
            </ul>
        </div>
